...
![Reflex Activation Timeline](results/reflex_activation_graph.png)
*Figure 1: Real-time reflex activation during grasp instability. The top panel shows geometric drift metrics crossing threshold (red dashed line), middle panel displays SNN membrane potential dynamics, and bottom panel indicates reflex veto assertion that overrides the AI policy command.*
